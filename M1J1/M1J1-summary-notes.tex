...
& \vdots \\
& \approx \epsilon_{0} F'(a)^{n}
\end{align}
It is easy to see that the iterative formula will only tend to the fixed point if $ |F'(a)| < 1 $. If $ |F'(a)| > 1 $, the error terms get bigger and the formula diverges.
